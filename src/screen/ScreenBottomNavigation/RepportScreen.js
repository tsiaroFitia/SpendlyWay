      ...
      <View style={styles.tabBarContainer}>
        <Tab.Navigator
          screenOptions={({ route }) => ({
            ...
            tabBarLabel: ({ focused }) => {
              const label = route.name === 'IncomeReport' ? 'Income' : 'Expense';
              ...
              return (
                <View style={styles.tabLabelContainer}>
                  <Ionicons
                    name={route.name === 'IncomeReport' ? 'arrow-up-circle-outline' : 'arrow-down-circle-outline'}
                    size={24}
                    color={textColor}
                  />
        ...
        >
          <Tab.Screen name="IncomeReport" component={IncomeReport} options={{ headerShown: false }} />
          <Tab.Screen name="ExpenseReport" component={ExpenseReport} options={{ headerShown: false }} />
        </Tab.Navigator>
      </View>
    </SafeAreaView>
  );
